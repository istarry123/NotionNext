...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Istarry', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://web.istarry.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '生活,工作,技术, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zjy442592754@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/istarry123', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  ANALYTICS_GOOGLE_ID: 'G-5NL2141TPC'
  // process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-5NL2141TPC', // 谷歌Analytics的id e.g: G-XXXXXXXXXX

  // 51la 站点统计 https://www.51.la/
  ANALYTICS_51LA_ID: '3MISPlhh3K3DrkiH'
  //process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3MISPlhh3K3DrkiH', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: '3MISPlhh3K3DrkiH'
  //process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3MISPlhh3K3DrkiH', // ck，在51la后台获取
